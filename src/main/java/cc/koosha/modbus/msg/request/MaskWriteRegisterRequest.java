...
import cc.koosha.modbus.msg.response.MaskWriteRegisterResponse;
 ...
 */
public final class MaskWriteRegisterRequest extends AbstractModbusRequest {
    ...
    public ModbusResponse createResponse(ProcessImage pi) {
        ...
        try {
            Register register = pi.getRegister(reference);
