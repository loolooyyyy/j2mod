...
import cc.koosha.modbus.msg.response.WriteSingleRegisterResponse;
 ...
 */
public final class WriteSingleRegisterRequest extends AbstractModbusRequest {
     ...
     */
    public WriteSingleRegisterRequest(int unitId, int ref, Register reg) {
        super();
