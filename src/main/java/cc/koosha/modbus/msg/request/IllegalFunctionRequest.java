...
import cc.koosha.modbus.msg.response.IllegalFunctionExceptionResponse;
 ...
 */
public class IllegalFunctionRequest extends AbstractModbusRequest {
    ...
    public ModbusResponse getResponse() {
        return updateResponseWithHeaderIgnoreFuncode(new IllegalFunctionExceptionResponse(getFunctionCode()));
    }
     ...
     * so it may not be possible to know exactly how much data needs to be
     * read.
     *
     * @throws java.io.IOException If the data cannot be read from the
     *                             socket/port
     */
