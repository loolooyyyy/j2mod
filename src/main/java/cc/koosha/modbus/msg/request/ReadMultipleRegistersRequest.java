...
import cc.koosha.modbus.msg.response.ReadMultipleRegistersResponse;
 ...
 */
public final class ReadMultipleRegistersRequest extends AbstractModbusRequest {
     ...
     */
    public ReadMultipleRegistersRequest(int unitId, int ref, int count) {
        super();
        setUnitID(unitId);
