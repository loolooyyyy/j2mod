...
import cc.koosha.modbus.msg.response.WriteMultipleCoilsResponse;
...
/**
 * Class implementing a <tt>WriteMultipleCoilsRequest</tt>. The implementation directly correlates with the class 1
 * function <i>write multiple coils (FC 15)</i>. It encapsulates the corresponding request message.
 *
 * <p>
 ...
 */
public final class WriteMultipleCoilsRequest extends AbstractModbusRequest {
    ...
    /**
     * Constructs a new <tt>WriteMultipleCoilsRequest</tt> instance with the given reference and coil values.
     *
     * @param ref the index of the first coil to be written.
     * @param bv  the coil values to be written.
     */
    public WriteMultipleCoilsRequest(int unitId, int ref, BitVector bv) {
        super();
        setUnitID(unitId);
    ...
    /**
     * Constructs a new <tt>WriteMultipleCoilsRequest</tt> instance with a given reference and count of coils to be
     * written, followed by the actual byte count, and then <i>count</i> number of bytes.
     *
     * @param ref   the index of the first coil to be written.
     * @param count the number of coils to be written.
     */
    public WriteMultipleCoilsRequest(int unitId, int ref, int count) {
        super();
        setUnitID(unitId);
    ...
    /**
     * getReference - Returns the reference of the coil to to start writing to with this
    ...
    /**
     * setReference - Sets the reference of the coil to start writing to with this <tt>WriteMultipleCoilsRequest</tt>.
     *
    ...
    /**
     * getByteCount - Returns the number of bytes required for packing the coils.
     *
    ...
    /**
     * getCoils - Returns the <tt>BitVector</tt> instance holding coil status information.
     *
    ...
    /**
     * setCoils - Sets the <tt>BitVector</tt> instance holding coil status information.
     *
    ...
    public void readData(DataInput din) throws IOException {
        ...
        coils = BitVector.valueOf(data, bitcount);
