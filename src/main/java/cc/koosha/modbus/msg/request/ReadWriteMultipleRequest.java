...
import cc.koosha.modbus.io.net.AbstractModbusListener;
import cc.koosha.modbus.msg.ModbusResponse;
import cc.koosha.modbus.msg.response.ReadWriteMultipleResponse;
 ...
 */
public final class ReadWriteMultipleRequest extends AbstractModbusRequest {
    ...
    /**
     * Constructs a new <tt>Read/Write Multiple Registers Request</tt>
     * instance.
     *
     * @param unit       Unit ID
     ...
     * @throws IndexOutOfBoundsException if the index is out of bounds.
     */
    public int getReadRegisterValue(int index) throws
