...
import cc.koosha.modbus.msg.response.ReadInputRegistersResponse;
 ...
 * function <i>read multiple registers (FC 4)</i>. It encapsulates the corresponding request message.
 *
 * @author Dieter Wimberger
 * @author Steve O'Hara (4NG)
 * @version 2.0 (March 2016)
 */
public final class ReadInputRegistersRequest extends AbstractModbusRequest {
    ...
    /**
     * Constructs a new <tt>ReadInputRegistersRequest</tt> instance with a given reference and count of words to be
     * read.
     * <p>
     *
     ...
     */
    public ReadInputRegistersRequest(int unitId, int ref, int count) {
        super();
    ...
    public ModbusResponse createResponse(ProcessImage pi) {
        ...
        List<InputRegister> inpregs;

        // 1. get process image
        // 2. get input registers range
        try {
            inpregs = pi.getInputRegisterRange(getReference(), getWordCount());
        }
